...
def test_qualifier_and_qualified_fact_match_as_edge_occurrences(embedder):
    ...
    purchase1 = g1.add_edge(acme1, datavault1, "acquire", "past")
    valuation1 = g1.add_edge(purchase1, price1, "value at", "past")

    g2 = Graph(id="article-2")
    acme2 = g2.add_entity("Acme Corp")
    datavault2 = g2.add_entity("DataVault")
    price2 = g2.add_entity("$4 billion")
    purchase2 = g2.add_edge(acme2, datavault2, "purchase", "past")
    valuation2 = g2.add_edge(purchase2, price2, "price at", "past")
...
def test_edge_used_as_target_matches_at_both_levels(embedder):
    ...
    visit1 = g1.add_edge(marisol1, vesterby1, "visit", "future")
    participation1 = g1.add_edge(ivo1, visit1, "join", "future")

    g2 = Graph(id="article-2")
    marisol2 = g2.add_entity("Marisol Vaneck")
    vesterby2 = g2.add_entity("Vesterby")
    ivo2 = g2.add_entity("Ivo Brandt")
    visit2 = g2.add_edge(marisol2, vesterby2, "travel to", "future")
    participation2 = g2.add_edge(ivo2, visit2, "take part in", "future")
...
def test_depth_two_edge_attachment_chain_matches_at_every_level(embedder):
    ...
    visit1 = g1.add_edge(lena1, torshavn1, "visit", "future")
    participation1 = g1.add_edge(pavel1, visit1, "join", "future")
    representation1 = g1.add_edge(participation1, council1, "on behalf of", "future")
    ...
    visit2 = g2.add_edge(lena2, torshavn2, "travel to", "future")
    participation2 = g2.add_edge(pavel2, visit2, "take part in", "future")
    representation2 = g2.add_edge(participation2, council2, "represent", "future")
...
def test_attachment_selects_the_corresponding_edge_occurrence(embedder):
    ...
    datavault2 = g2.add_entity("DataVault")
    price2 = g2.add_entity("$4 billion")
    qualified_purchase2 = g2.add_edge(acme2, datavault2, "purchase", "past")
    other_purchase2 = g2.add_edge(acme2, datavault2, "purchase", "past")
    valuation2 = g2.add_edge(qualified_purchase2, price2, "price at", "past")
...
def test_relation_to_relation_on_both_endpoints_matches_recursively(embedder):
    ...
    closure1 = g1.add_edge(halden1, station1, "close", "past")
    suspension1 = g1.add_edge(meridian1, kalden1, "suspend services to", "past")
    cause1 = g1.add_edge(closure1, suspension1, "cause", "past")
    ...
    closure2 = g2.add_edge(halden2, station2, "shut down", "past")
    suspension2 = g2.add_edge(meridian2, kalden2, "halt services to", "past")
    cause2 = g2.add_edge(closure2, suspension2, "result in", "past")
